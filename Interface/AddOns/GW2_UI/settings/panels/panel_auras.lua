...
local function LoadAurasPanel(sWindow)
    ...
    p_auras.header:SetWidth(p_auras.header:GetStringWidth() + 10)
    ...
    p_indicator.header:SetWidth(p_indicator.header:GetStringWidth() + 10)
    ...
    p_missingBuffs.header:SetWidth(p_missingBuffs.header:GetStringWidth() + 10)
