...
local function LoadTargetPanel(sWindow)
    ...
    pPlayerPet.header:SetWidth(pPlayerPet.header:GetStringWidth() + 10)
    ...
    p_target.header:SetWidth(p_target.header:GetStringWidth() + 10)
    ...
    pTargetOfTarget.header:SetWidth(pTargetOfTarget.header:GetStringWidth() + 10)
    ...
    p_focus.header:SetWidth(p_focus.header:GetStringWidth() + 10)
    ...
    pTargetOfFocus.header:SetWidth(pTargetOfFocus.header:GetStringWidth() + 10)
    ...
    party.header:SetWidth(party.header:GetStringWidth() + 10)
