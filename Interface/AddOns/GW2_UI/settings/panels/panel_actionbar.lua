...
local function LoadActionbarPanel(sWindow)
    ...
    mainBar.header:SetWidth(mainBar.header:GetStringWidth() + 10)
    ...
    extraBars.header:SetWidth(extraBars.header:GetStringWidth() + 10)
    ...
    stanceBar.header:SetWidth(stanceBar.header:GetStringWidth() + 10)
