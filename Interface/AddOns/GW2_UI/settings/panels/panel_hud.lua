...
local function LoadHudPanel(sWindow)
    ...
    general.header:SetWidth(general.header:GetStringWidth() + 10)
    ...
    microBar.header:SetWidth(microBar.header:GetStringWidth() + 10)
    ...
    chatBubbles.header:SetWidth(chatBubbles.header:GetStringWidth() + 10)
    ...
    minimap.header:SetWidth(minimap.header:GetStringWidth() + 10)
    ...
    worldmap.header:SetWidth(worldmap.header:GetStringWidth() + 10)
    ...
    worldEvents.header:SetWidth(worldEvents.header:GetStringWidth() + 10)
    ...
    fct.header:SetWidth(fct.header:GetStringWidth() + 10)
    ...
    questing.header:SetWidth(questing.header:GetStringWidth() + 10)
