...
local function LoadPlayerPanel(sWindow)
    ...
    p_player.header:SetWidth(p_player.header:GetStringWidth() + 10)
    ...
    p_player_aura.header:SetWidth(p_player_aura.header:GetStringWidth() + 10)
    ...
    castbar.header:SetWidth(castbar.header:GetStringWidth() + 10)
    ...
    fader.sub:SetText("")
    fader.header:SetWidth(fader.header:GetStringWidth() + 10)
    ...
    classpower.header:SetWidth(classpower.header:GetStringWidth() + 10)
    ...
    totemBar.header:SetWidth(totemBar.header:GetStringWidth() + 10)
