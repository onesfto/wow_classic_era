...
local function LoadRaid10Profile(panel)
    ...
    raid10.header:SetWidth(raid10.header:GetStringWidth() + 10)
...
local function LoadRaid25Profile(panel)
    ...
    raid25.header:SetWidth(raid25.header:GetStringWidth() + 10)
...
local function LoadRaid40Profile(panel)
    ...
    raid40.header:SetWidth(raid40.header:GetStringWidth() + 10)
...
local function LoadMaintankProfile(panel)
    ...
    tank.header:SetWidth(tank.header:GetStringWidth() + 10)
...
local function LoadRaidPetProfile(panel)
    ...
    p.header:SetWidth(p.header:GetStringWidth() + 10)
