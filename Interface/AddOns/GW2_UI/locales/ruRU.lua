...
L["%s created a Soulwell."] = "%s создаёт Источник душ."
L["%s created a table of Conjured Refreshments."] = "%s сотворяет Стол с яствами."
L["%s Indicator"] = "%s индикация"
L["%s is performing a Ritual of Summoning."] = "%s начинает Ритуал призыва."
L["%s placed a portal to %s."] = "%s создаёт портал в %s."
L["%s slot needs to repair, current durability is %d."] = "%s слот нуждается в ремонте, текущая прочность %d."
L[": Show numbers with commas"] = ": десятичный разделитель"
L[": Use Blizzard colors"] = ": цвет шрифта Blizzard"
L["<Assign specializations>"] = "<Назначить специализации>"
...
L["Add timestamp to all messages"] = "Показывать время отправки всех сообщений"
L["AddOn Memory:"] = "Потребление ОЗУ аддоном:"
...
L["Animated"] = "Анимация"
L["Applies the UI scale to all frames, which can be scaled in 'Move HUD' mode."] = "Применить текущий масштаб ко всем изменяемым фреймам в режиме \"Перемещение\"."
L["Apply UI to all"] = "Применить везде"
L["Are you sure you want to delete the selected layout?"] = "Вы хотите удалить выбранный слой?"
...
L["Assign layouts to a spec. The layout will be automatically changed on a spec switch.\\n\\nLayouts has always priority for profile settings."] = "Привязать слои к спеку. Слой будет автоматически сменён при смене спека. \\n\\nПриоритет слоев определяется настройками."
...
L["Boss frames: Separate Energy Bar"] = "Фрейм босса: Отделить полосу энергии"
L["Bottom"] = "Внизу"
L["Buff size"] = "Размер баффов"
L["Buffs"] = "Баффы"
L["Button Spacing"] = "Межкнопочный интервал"
L["By growth direction"] = "По росту фреймов"
L["By position on screen"] = "K позиции фреймов"
L["Calendar invite"] = "Приглашение через календарь"
L["Center"] = "По центру"
L["Change the HUD size."] = "Размер HUD."
L["Change the Minimap size."] = "Размер мини-карты."
L["Changelog"] = "Журнал изменений"
L["Changes the chat font, timestamp color and name display"] = "Изменить шрифт в чате, цвет времени отправки и отображение имени"
L["Chromie Time Frame"] = "Фрейм Времени Хроми"
...
L["Combat Override Key"] = "Смена привязки клавиш в бою"
...
L["Ctrl & Shift Click: Toggle CPU Profiling"] = "Ctrl & Shift клик: Переключить CPU профиль"
...
L["Defines how the group is sorted"] = "Определяет, как сортируется группа"
L["Defines the sort order of the selected sort method"] = "Определяет порядок метода сортировки"
...
L["Edit raid aura indicators."] = "Редактирование индикаторов аур в рейде."
L["Edit raid buff bar."] = "Изменение настроек панели рейд-баффов."
L["Edit the group settings."] = "Настройка фреймов в группе/рейде."
...
L["Edit the party and raid options to suit your needs."] = "Настроить окна группы и рейда под ваши потребности."
...
L["Extended Vendor"] = "Поставщик"
L["Extra Frame Options"] = "Настройки дополнительных фреймов"
...
L["Group Frames"] = "Фрейм группы"
L["GW2 Chat Message Style"] = "GW2-стиль сообщений чата"
...
Some of the modules available to you are an immersive questing window, a full inventory replacement, as well as a full character window replacement. There are many more that you can enjoy, just take a look in the settings menu to see what's available to you!]=] ] = [=[GW2 UI - это полная замена пользовательского интерфейса. Мы создали модульный интерфейс, и его суть в том, что вы сможете отключить любые его части, если они вам не нравятся или их функции заменены другими аддонами, при этом оставляя остальной интерфейс нетронутым.
Вот некоторые из модулей: захватывающее оформление квестов, новый вид инвентаря, а также совершенно новый стиль окна персонажа. Среди остального также полно того, что вам может подойти, так что просто осмотритесь в настройках и попробуйте всё!]=]
...
L["Home Latency:"] = "Задержка:"
L["Home Protocol:"] = "Протокол:"
L["Horizontal"] = "Горизонтально"
L["HUD Scale"] = "Масштаб HUD"
L["Hyperlink Hover"] = "Подсказки в чате"
L["I"] = "П"
L["If both scales could apply to a debuff, which one should be used"] = "Выбрать приоритет категорий дебаффа"
...
L["If enabled, enabled bosses’ energy bars will be shown separately from their health bar."] = "Если включить, полосы энергии и здоровья боссов отобразятся раздельно."
...
L["IL"] = "Л"
L["Immersive Questing"] = "Улучшенное оформление заданий"
L["Import"] = "Импорт"
...
L["Important & dispellable debuff scale priority"] = "Категория важных и рассеивыемых дебаффов"
...
L["Index"] = "Индекс"
L["Indicate whether buffs you cast yourself should be separated before or after"] = "Укажите, следует ли разделять накладываемые вами баффы до или после"
...
L["Left"] = "Влево"
L["Left click on a moverframe to show extra frame options"] = "Правый клик на фрейме для дополнительных параметров"
...
L["Mage portal"] = "Портал мага"
L["Mage Table"] = "Стол мага"
L["Main Bar Range Indicator"] = "Проверка расстояния для главной панели действий"
L["Map Coordinates"] = "Координаты на карте"
L["Mark Quest Reward"] = "Отметить награды за задания"
L["Marks the most valuable quest reward with a gold coin."] = "Отметить монеткой лучшие квестовые награды."
...
L["Minimap Scale"] = "Масштаб мини-карты"
...
L["Modifier to hold to show the tooltip in combat."] = "Зажимаемая клавиша для фрэйма подсказки в бою."
...
L["New layout name:"] = "Название нового слоя:"
L["New mail"] = "Новые письма"
L["New spell"] = "Новая способность"
...
L["Number of columns in the two extra right-hand action bars."] = "Количество столбцов для двух дополнительных панелей команд справа."
L["Number of messages you scroll for each step."] = "Количество проматываемых сообщений за раз."
...
L["Number of time in seconds to scroll down to the bottom of the chat window if you are not scrolled down completely."] = "Время в секундах для прокрутки сообщений в самый низ чата из любого места в чате."
L["O"] = "Оф"
L["One or more of the changes you have made require a UI reload."] = "Одно или несколько новых изменений потребуют перезагрузки интерфейса."
...
L["Only takes effect if 'Cursor Tooltips' is enabled"] = "Действует при включённой опции \"Подсказки у курсора\""
L["Only takes effect if 'Cursor Tooltips' is enabled and the cursor anchor is not 'Cursor Anchor'"] = "Действует при включённой опции \"Подсказки у курсора\" и без привязки к курсору"
L["Other's First"] = "Приоритет чужих"
L["Out of combat"] = "Не в бою"
L["P"] = "Гр"
L["Paragon"] = "Припасы"
L["Paragon chest"] = "Дар герою"
L["Paste your profile string here to import the profile."] = "Для импорта профиля вставьте сюда код профиля."
L["Pixel Perfect Mode"] = "Режим Pixel Perfect"
L["PL"] = "ПЛ"
L["Player Buff Growth Direction"] = "Направление новых баффов"
L["Player de/buff animation"] = "Анимация баффов/дебаффов игрока"
...
L["Rare on minimap"] = "Редкий монстр на миникарте"
L["Red Overlay"] = "Красный индикатор"
L["Rename layout:"] = "Переименовать слой:"
L["Repair needed"] = "Нужен ремонт"
...
L["Scale"] = "Масштаб"
L["Scale with Right Click"] = "Масштабирование правым кликом"
L["Scales the UI into a Pixel Perfect Mode. This is dependent on screen resolution."] = "Масштабировать интерфейс под режим Pixel Perfect. Зависит от разрешения экрана."
L["Scroll Interval"] = "Интервал прокрутки"
L["Scroll Messages"] = "Прокрутка сообщений"
L["Secure"] = "Безопасный"
...
L["Shift Click: Collect Garbage"] = "Shift клик: Собрать мусор"
L["Short Channels"] = "Краткие названия каналов"
L["Shorten the channel names in chat."] = "Сокращать названия каналов в чате."
L["Show alternative background texture"] = "Альтернативная текстура фона "
...
L["Show Health Bar Text"] = "Текст на полосе здоровья"
...
L["Show Macro Name"] = "Название макросов"
L["Show Macro Name on Action Button"] = "Показывать названия макросов на панелях."
...
L["Show spell queue window on castingbar"] = "Задержка заклинаний на кастбаре"
...
L["Shows an animation for new de/buffs"] = "Показывать анимацию для новых баффов/дебаффов"
L["Shows the xp you got from that quest in % based on your total needed xp for next level."] = "Показывать количество опыта за задание в процентах от общего опыта за уровень."
L["Skins"] = "Скины"
L["Skip"] = "Продолжить"
L["Socket Frame"] = "Фрейм для гнезд"
...
L["Spec is already assigned to a layout!"] = "Спек уже привязан к слою!"
L["Spent:"] = "Потрачено:"
...
L["The number of pages shown in the merchant frame. Set 1 to disable."] = "Видимое количество страниц окна торговца. Значение 1 для отключения."
...
L["Total CPU:"] = "Процессор:"
L["Turn Pixel Perfect Mode On"] = "Включить режим Pixel Perfect"
L["Up"] = "Bверх"
...
GW2 UI has a built-in setting called 'Pixel Perfect Mode'. What this means for you is that your user interface will look as was intended, with crisper textures and better scaling. Of course, you can toggle this off in the settings menu should you prefer.]=] ] = "Что такое 'Pixel Perfect'? Это название режима масштабирования в GW2 UI. С ним ваш интерфейс будет выглядеть, как задумано, текстуры интерфейса будут более чёткими и масштабирование улучшится. Вы всегда можете отключить этот режим в настройках."
...
L["Whether to display a floating bar showing your group or raid's role composition. This can be moved via the 'Move HUD' interface."] = "Отображать панель с составом ролей вашей группы или рейда. Она может быть перемещена в режиме \"Перемещение\"."
...
L["World Latency:"] = "Пинг:"
L["World Protocol:"] = "Протокол соединения:"
L["XP Quest Percent"] = "Опыт за задание в процентах"
L["You can not move elements during combat!"] = "Перемещать элементы интерфейса в бою нельзя!"
L["You have %s pending calendar invite(s)."] = " Новых приглашений в календаре: %s."
L["You have %s pending guild event(s)."] = "Новых гильдейских событий: %s."
...
L["Your Auras First"] = "Приоритет своих аур"
