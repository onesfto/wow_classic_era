...
L["Choose from predefined options to customize fonts and text styles, adjusting the appearance of your text."] = "從預先設定好的選項中選擇自訂字體和文字樣式，調整你的文字外觀。"
...
L["Click to show location"] = "點一下顯示位置"
...
L["Desaturate the icon if the event is completed this week."] = "本週已完成的事件圖示去飽和度。"
L["Descending"] = "遞減"
L["Developed by"] = "程式設計"
...
L["If disabled, progress bars will not be shown for various objective tracker items such as quests, achievements, etc."] = "停用時，不會顯示各目標追蹤項目 (例如任務、成就等) 的進度條。"
...
L["Keywords"] = "關鍵字"
L["Khaz Algar Emissary"] = "卡茲阿爾加特使"
L["Last updated: "] = [=[
上次更新: ]=]
L["Leader/Assist Icon"] = "隊長/助理圖示"
L["Left"] = "左側"
...
L["Only takes effect if 'Cursor Tooltips' is enabled"] = "只有啟用 '浮動提示資訊跟隨游標' 時才有效果。"
L["Only takes effect if 'Cursor Tooltips' is enabled and the cursor anchor is not 'Cursor Anchor'"] = "只有啟用 '浮動提示資訊跟隨游標'，而且跟隨游標位置不是 '游標指向點' 時才有效果。"
...
L["Show Objective Tracker progress bars"] = "顯示目標追蹤進度條"
...
L["This setting controls the size of text in item comparison tooltips"] = "此設定控制物品比較浮動提示資訊中的文字大小"
...
L["Tooltip Body"] = "浮動提示資訊內容"
L["Tooltip Header"] = "浮動提示資訊標題"
L["Tooltips"] = "浮動提示資訊"
L["Top"] = "上方"
L["Top Left"] = "左上"
L["Top Right"] = "右上"
...
L["Use GW2 Text Style Template"] = "使用 GW2 文字樣式範本"
...
L["World Map Coordinates"] = "世界地圖座標"
