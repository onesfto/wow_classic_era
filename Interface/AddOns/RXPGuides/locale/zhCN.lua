...
-- 露露备注：升级通知，修复代码错误（2025年4月29日）
L["I just leveled from %d to %d in %s"] = "我刚刚从 %s 级升到了 %d 级"
...
L["Train skills"] = "学习技能"
L["Step skipped: Missing pre-requisites"] = "此步已跳过: 缺少前置条件"
L["Do NOT attempt this quest unless you are in a group of at least %d"] = "不要尝试此任务除非你在至少%d人的队伍中"
L["Step %d"] = "第%d步"
