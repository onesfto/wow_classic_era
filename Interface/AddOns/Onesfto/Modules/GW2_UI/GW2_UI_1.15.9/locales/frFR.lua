...
L["%s created a Soulwell."] = "%s a créé une guérison d'âme."
L["%s created a table of Conjured Refreshments."] = "%s a créé une table de rafraîchissements."
L["%s Indicator"] = "Indicateur %s"
L["%s is performing a Ritual of Summoning."] = "%s exécute un Rituel d'Invocation."
L["%s placed a portal to %s."] = "%s a placé un portail vers %s."
L["%s slot needs to repair, current durability is %d."] = "L'emplacement %s doit être réparé, la durabilité actuelle est de %d."
L["%s will start in %s!"] = [=[%s Commence dans %s!

]=]
L[": Show numbers with commas"] = ": Montrer les chiffres avec virgules"
L[": Use Blizzard colors"] = ": Utiliser les couleurs de Blizzard"
L["|cffFFFFFFLeft Click:|r Show Talent Specialization UI"] = "|cffFFFFFF Clic Gauche :|r Afficher les Spécialisations et Talents"
L["|cffFFFFFFRight Click:|r Change Loot Specialization"] = "|cffFFFFFF Clic Droit :|r Changer la Spécialisation du butin"
L["|cffFFFFFFShift + Left Click:|r Change Talent Specialization"] = "|cffFFFFFF Shift + Clic Gauche:|r Changer les Spécialisations et Talents"
L["<Assign specializations>"] = "<Attribuer des spécialisations>"
...
L["Add timestamp to all messages"] = "Ajouter un horodatage à tous les messages"
L["Add trackers for world events in the bottom of world map."] = "Ajouter un suivi des évènements mondiaux en bas de la carte."
L["AddOn Memory:"] = "Mémoire des AddOn:"
L["Adds descriptions for mythic keystone properties to their tooltips."] = "Ajouter une description pour aux propriétés clefs mythique à leurs info-bulles."
...
L["Alert will be triggered when the remaining time is less than the set value."] = "L'alerte sera déclenchée lorsque le temps restant est inférieur à la valeur définie."
...
L["Are you sure you want to delete the selected layout?"] = "Voulez-vous vraiment supprimer la mise en page sélectionnée ?"
...
L["Assign layouts to a spec. The layout will be automatically changed on a spec switch.\\n\\nLayouts has always priority for profile settings."] = "Attribuez des mises en page à une spécialisation. La mise en page sera automatiquement modifiée lors d'un changement de spécialisation.\\n\\nLa mise en page a toujours priorité pour les paramètres du profil."
...
L["Boss frames: Separate Energy Bar"] = "Cadres de boss : barre d'énergie séparée"
L["Bottom"] = "Bas"
...
L["Calendar invite"] = "Invitation de calendrier"
L["Center"] = "Centre"
...
L["Changes the chat font, timestamp color and name display"] = "Modifie la police du chat, la couleur de l'horodatage et l'affichage du nom"
...
L["Click to open Emoticon Frame"] = "Cliquez pour ouvrir le cadre d'Emoticon"
...
L["Collapse all objectives in M+"] = "Réduire tous les objectifs en M+"
L["Combat Override Key"] = "abandon de la clef"
L["Community Feast"] = "Festin Tribal"
L["Compact Icons"] = "Icônes compactes"
L["Complete"] = "Terminée"
L["Conduits"] = "Conduits"
L["Cooking"] = "En train de cuisiner"
L["Coordinates"] = "Coordonnées"
L["Copy of"] = "Copie de"
L["Created by: "] = "Créé par : "
L["Created: "] = "Créé : "
L["Credits"] = "Crédits"
L["Ctrl & Shift Click: Toggle CPU Profiling"] = "Ctrl & Maj Clic : Activer ou Déactiver le profilage du processeur"
...
L["Deficit:"] = "Déficit :"
L["Defines how the group is sorted"] = "Définit comment le groupe est trié"
L["Defines the sort order of the selected sort method"] = "Définit l'ordre de tri de la méthode sélectionnée"
L["Desaturate Icon"] = "Icônes grisés"
L["Desaturate the icon if the event is completed this week."] = "Icônes grisés si l'évènement est terminé cette semaine."
...
L["Dragonbane Keep"] = "Donjon du Fléau-des-Dragons"
...
L["Edit objectives settings."] = "Editer les paramètres d'objectif."
...
L["GW2 Chat Message Style"] = "Message du chat dans le style de GW2"
...
L["has appeared on the Minimap!"] = "est apparue sur la minicarte !"
L["Health Bar Position"] = "Position de la barre de santé"
...
L["I"] = "I"
L["If both scales could apply to a debuff, which one should be used"] = "Si les deux échelles peuvent s'appliquer à un affaiblissement, laquelle doit être utilisée"
...
L["If enabled, enabled bosses’ energy bars will be shown separately from their health bar."] = "Si activé, les barres d'énergie des boss actif seront affichées séparément de leur barre de santé"
...
L["If enabled, this will show both the stylised party frames as well as the grid frame. This setting has no effect if '%s' is enabled."] = "Si activé, cela affichera à la fois les cadres de groupe stylisés ainsi que les cadres de raid. Ce paramètre n'a aucun effet si '%s' est activé."
...
L["Important & dispellable debuff scale priority"] = "Priorité de l'échelle des affaiblissements important et dissipable"
L["Important > Dispell"] = "Important > Dissiper"
...
L["Index"] = "Index"
L["Indicate whether buffs you cast yourself should be separated before or after"] = "Indiquez si les améliorations que vous lancez vous-même doivent être séparées avant ou après"
L["Installation"] = "Installation"
L["Installation Complete"] = "Installation terminée"
L["Interval"] = "Intervalles"
...
L["is looking for members"] = "recherche des membres"
L["Item Count"] = "Nombre d'objets"
L["Join Discord"] = "Rejoindre le Discord"
L["joined a group"] = "a rejoint un groupe"
L["Keyword Alert"] = "Alerte mot-clé"
L["Keyword highlight color"] = "Couleur de surlignage du mot-clé"
L["Keywords"] = "Mot-clés"
L["Last updated: "] = "Dernière mise à jour : "
L["Left"] = "Gauche"
L["Left click on a moverframe to show extra frame options"] = "Clic droit sur un cadre mobile pour afficher les options de cadre supplémentaires"
...
L["List of words to color in chat if found in a message. If you wish to add multiple words you must seperate the word with a comma. To search for your current name you can use %MYNAME%.\\n\\nExample:\\n%MYNAME%, Heal, Tank"] = "Liste de mots à colorier dans le chat s'ils sont trouvés dans un message. Si vous souhaitez ajouter plusieurs mots, vous devez séparer le mot par une virgule. Pour rechercher votre nom actuel, vous pouvez utiliser %MYNAME%.\\n\\nExemple :\\n%MYNAME%, Heal, Tank"
L["Load"] = "Charger"
...
L["Mage Table"] = "Table de mage"
L["Main Bar Range Indicator"] = "Indicateur de portée sur la barre principale"
L["Map Coordinates"] = "Coordonnées de la carte"
L["Mark Quest Reward"] = "Marquer la récompense de la quête"
L["Marks the most valuable quest reward with a gold coin."] = "Marque la récompense de quête valent le plus cher avec une pièce d'or."
...
L["Modifier to hold to show the tooltip in combat."] = "Touche à maintenir pour afficher l'infobulle en combat."
...
L["New layout name:"] = "Nouveau nom de mise en page :"
...
L["Number of messages you scroll for each step."] = "Nombre de messages que vous faites défiler pour chaque étape."
L["Number of repeat characters while in combat before the chat editbox is automatically closed, set to zero to disable."] = "Nombre de caractères répétés pendant le combat avant que le champ de saisie du chat ne soit automatiquement fermée, mettre à zéro pour désactiver."
L["Number of time in seconds to scroll down to the bottom of the chat window if you are not scrolled down completely."] = "Nombre de secondes pour faire défiler vers le bas la fenêtre de discussion, si vous n'êtes pas complètement descendu."
L["O"] = "O"
L["One or more of the changes you have made require a UI reload."] = "Une ou plusieurs des modifications que vous avez apportées nécessitent un rechargement de l'interface utilisateur."
...
L["Only takes effect if 'Cursor Tooltips' is enabled"] = "Ne prend effet que si l'option \"Info-bulles du curseur\" est activée"
L["Only takes effect if 'Cursor Tooltips' is enabled and the cursor anchor is not 'Cursor Anchor'"] = "Ne prend effet que si l'option \"Info-bulles du curseur\" est activée et que l'ancre du curseur n'est PAS \"Ancre du curseur\"."
L["Out of combat"] = "Hors-combat"
L["P"] = "G"
L["Paragon"] = "Parangon"
L["Paragon chest"] = "Coffre de parangon"
...
L["Player de/buff animation"] = "Animation des Affaiblissements et Améliorations du joueur"
...
L["Prevent the same messages from displaying in chat more than once within this set amount of seconds, set to zero to disable."] = "Empêchez le même message de s'afficher plus d'une fois dans le chat pendant ce nombre de secondes défini, mettre à zéro pour désactiver."
...
L["Rare on minimap"] = "Rare sur la minicarte"
L["Ready to craft"] = "Commencer la commande"
L["Red Overlay"] = "Masque de superposition rouge"
L["Rename layout:"] = "Renommer la mise en page :"
L["Repair needed"] = "Réparation nécessaire"
...
L["Scroll Messages"] = "Faire défiler les messages"
L["Secure"] = "Sécurisée"
...
L["Seperate"] = "Séparée"
L["Session:"] = "Session :"
L["Set dispellable debuff scale"] = "Définir l'échelle d'affaiblissement dissipable"
L["Set important Dungeon & Raid debuff scale"] = "Définissez l'échelle d'affaiblissements important de Donjon & Raid"
...
L["Shift Click: Collect Garbage"] = "Maj Clic : Récupérer les déchets"
L["Short Channels"] = "Canaux courts"
L["Shorten the channel names in chat."] = "Raccourcir le nom des canaux dans la fenêtre de discussion."
L["Show alternative background texture"] = "Afficher une texture d'arrière-plan alternative"
L["Show an additional resource bar"] = "Afficher une barre de ressources supplémentaire"
L["Show Aura Tooltips"] = "Afficher les infobulles des auras en combat"
L["Show auras below"] = "Afficher les améliorations en dessous"
L["Show both party frames and party grid"] = "Afficher les cadres de groupe et de raid"
L["Show clickable Quick Join messages inside of the chat."] = "Afficher les messages d'invitations dans le chat."
...
L["Show Health Bar Text"] = "Afficher le texte de la barre de santé"
...
L["Show Macro Name"] = "Afficher le nom des macros"
L["Show Macro Name on Action Button"] = "Afficher le nom des macros sur le bouton d'action"
...
L["Show spell queue window on castingbar"] = "Voir la liste des sorts dans la barre d'incantation"
...
L["Shows an animation for new de/buffs"] = "Affiche une animation pour les nouveaux de/buffs"
L["Shows the xp you got from that quest in % based on your total needed xp for next level."] = "Affiche l'xp que vous avez obtenu de cette quête en % en fonction de votre total d'xp nécessaire pour le niveau suivant. "
L["Siege On Dragonbane Keep"] = "Siège du donjon du Fléau-des-Dragons"
L["Skins"] = "Habillage"
L["Skip"] = "Passer"
L["Socket Frame"] = "Fenêtre de sertissage"
L["Sort Direction"] = "Trier par direction"
...
L["Soulwell"] = "Puits des âmes"
L["Spam Interval"] = "Intervalle de spam"
L["Spec is already assigned to a layout!"] = "La spécialisation est déjà affectée à une mise en page !"
L["Spent:"] = "Dépensé:"
L["Stance Bar Growth Direction"] = "Direction de déploiement de la barre spéciale"
L["Start installation"] = "Démarrer l'installation"
L["Stop alert when the event is completed in this week."] = [=[Stop alert when the event is completed in this week.
Arrêter l'alerte quand l'évènement est terminé cette semaine.]=]
L["System info"] = "Info Système"
...
L["The number of pages shown in the merchant frame. Set 1 to disable."] = "Le nombre de pages affichées dans le cadre du marchand. Réglez 1 pour désactiver."
...
L["Use class color for the names of players when they are mentioned."] = "Utiliser la couleur de la classe pour les noms des joueurs lorsqu'ils sont mentionnés."
...
L["Whether to display a floating bar showing your group or raid's role composition. This can be moved via the 'Move HUD' interface."] = "Afficher ou non une barre flottante indiquant la composition des rôles de votre groupe ou de votre raid. Celle-ci peut être déplacé via l'interface 'Déplacer l'ATH'."
L["Whether to display a floating bar showing your missing buffs. This can be moved via the 'Move HUD' interface."] = "Afficher ou non une barre flottante montrant vos améliorations manquants. Celle-ci peut être déplacé via l'interface 'Déplacer l'ATH'."
L["With Contributions by"] = "Avec la contribution de"
L["World Latency:"] = "Latence Monde"
L["World Protocol:"] = "Context???????"
L["XP Quest Percent"] = "% d'XP de quêtes. "
L["You can not move elements during combat!"] = "Vous ne pouvez pas déplacer ces éléments durant un combat!"
L["You have %s pending calendar invite(s)."] = "Vous avez %s invitation(s) de calendrier en attente."
L["You have %s pending guild event(s)."] = "Vous avez %s évènement(s) de guilde en attente."
...
L["Your Auras First"] = "Votre Aura en premier"
