...
DBM.Revision = parseCurseDate("20260826083115")
...
---@param revision number|string Either a number in the format "202101010000" (year, month, day, hour, minute) or string "20260826083115" to be auto set by packager
