...
L.TOC_PRICES = [[
查询角色所在服务器TOC团本装备的最新物价，
也可以直接指定服务器进行查询。
每小时更新一次成交价，取实际交易价格中位数。]]

L.TASK_GUIDE_TITLE = [[【任务指引】功能简介：]]

L.TASK_GUIDE = [[
绑定怀旧服账号角色，可查询该角色下WLK、
TBC版本任务详情，显示任务目标、开始/结束位置、
等级要求等关键信息。]]

L.CUSTOMS_TITLE = [[【副本攻略】功能简介：]]

L.CUSTOMS = [[
介绍TOC团队副本中各BOSS技能机制与战斗流程，
帮助玩家快速了解每场BOSS战斗中各职责需要注意
的事项与细节。]]

L.ROLE_REPORT_TITLE = [[【角色周报】功能简介：]]

L.ROLE_REPORT = [[
查询角色每周游戏数据：活跃天数、击杀怪物、死亡次数、
成就获取、金币装备纹章获取变动、
副本团本完成次数、boss击杀数量，
综合以上信息，生成角色每周评定报告，可进行一键分享。]]
