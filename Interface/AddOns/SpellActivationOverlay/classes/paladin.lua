...
if false
or SAO.IsProject(SAO.MOP_AND_ONWARD)
then
SAO:CreateEffect(
"how",
SAO.MOP_AND_ONWARD,
...
state.isDemonOrUndead=creatureType==3 or creatureType==6
...
buttons={holyLight,divineLight,holyRadiance,default={option={isNative=true}}},
}
)
else
...
buttons={
[SAO.CATA]=holyShock,
[SAO.MOP_AND_ONWARD]={spellID=holyShock,option={isNative=true}},
}
}
)
end
...
[SAO.MOP_AND_ONWARD]={spellID=avengersShield,option={isNative=true}},
},
}
)
end
...
talent=87138,
overlay={texture="art_of_war",position="Left + Right (Flipped)"},
button={spellID=exorcism,option={isNative=true}},
}
)
end
end
...
{
talent=85804,
button={spellID=flashOfLight,stacks=3,option={isNative=true}},
}
)
end
end
