...
button={stacks=5,spellID=focusFire,option={isNative=true}},
}
)
end
...
[SAO.MOP]={spellID=aimedShot,option={isNative=true}},
}
}
)
end
...
[SAO.MOP_AND_ONWARD]={spellID=explosiveShot,option={isNative=true}},
},
}
)
end
...
buttons={arcaneShot,multiShot,default={option={isNative=true}}},
}
)
end
