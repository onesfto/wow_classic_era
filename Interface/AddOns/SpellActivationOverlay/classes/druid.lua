...
buttons={
[SAO.CATA]=starsurge,
[SAO.MOP_AND_ONWARD]={starsurge,default={option={isNative=true}}},
},
}
)
end
...
buttons={moonfire,starfire,default={option={isNative=true}}},
}
)
SAO:CreateEffect(
"eclipse_solar",
...
button={spellID=wrath,option={isNative=true}},
}
)
end
...
button={spellID=maul,option={isNative=true}},
}
)
end
...
[SAO.MOP]={healingTouch,rebirth,default={option={isNative=true}}},
},
}
)
