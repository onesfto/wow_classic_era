...
[SAO.MOP]={spellID=colossusSmash,option={isNative=true}},
},
}
)
end
...
[SAO.MOP]={spellID=wildStrike,option={isNative=true}},
},
}
)
end
...
[SAO.MOP]={spellID=shieldSlam,option={isNative=true}},
},
}
)
end
...
buttons={heroicStrike,cleave,default={option={isNative=true}}},
}
)
end
