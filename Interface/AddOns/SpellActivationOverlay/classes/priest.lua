...
button={spellID=mindSpike,option={isNative=true}},
}
)
end
end
...
local execThreshold=SAO.IsProject(SAO.MOP_AND_ONWARD) and 20 or 25
SAO:CreateEffect(
"sw_death",
SAO.MOP_AND_ONWARD +
SAO.CATA,
...
{
talent=33371,
button={stacks=2,spellID=mindBlast,option={isNative=true}},
}
)
end
