local AddonName,SAO=...
local Module="option"
function SAO.AddGlowingOption(self,talentID,spellID,glowID,talentSubText,spellSubText,variants,hash,alwaysHideTalentText,infoTooltip)
...
spellID,
glowID,
type(variants)=='table' and variants.values,
applyTextFunc,
testFunc,
{frame=SpellActivationOverlayOptionsPanelGlowingButtons,xOffset=16,yOffset=2},
infoTooltip
)
end
