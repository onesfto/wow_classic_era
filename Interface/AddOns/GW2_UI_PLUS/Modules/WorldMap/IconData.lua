local _, addonTable = ...
	...
	frame:SetScript("OnEvent", function()
		...
		if class == "DRUID" then
			...
			tinsert(WorldMapData.icons[1450], {"FlightA", 44.1, 45.2, L["Nighthaven"] .. ", " .. L["Moonglade"], L["Druid only flight point to Darnassus"], tATex, nil, nil})
			tinsert(WorldMapData.icons[1450], {"FlightH", 44.3, 45.9, L["Nighthaven"] .. ", " .. L["Moonglade"], L["Druid only flight point to Thunder Bluff"], tHTex, nil, nil})
		end
