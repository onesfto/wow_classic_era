...
local function CreateStatusPanel(
    ...
    local energyEnabled = AddClonedOption(
        panel, options.powerBar, "启用", "能量条", 2, nil, true)
    ...
    AddClonedOption(
        panel, options.customSide, "自定义侧边", "资源条", 2)
    AddClonedOption(
        panel, options.offsetX, "X 偏移", "资源条", 3)
    AddClonedOption(
        panel, options.offsetY, "Y 偏移", "资源条", 3)
    AddClonedOption(
        panel, options.gap, "间距", "资源条", 3)
    AddClonedOption(
