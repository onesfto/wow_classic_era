...
require_text Modules/General/BuyEmAllClassic.xml '<Offset x="31" y="0" />'
require_text Modules/General/BuyEmAllClassic.xml '<Offset x="99" y="0" />'
require_text Modules/General/BuyEmAllClassic.xml '<Offset x="167" y="0" />'
require_text Modules/General/BuyEmAllClassic.xml '<Offset x="23" y="0" />'
require_text Modules/General/BuyEmAllClassic.xml '<Offset x="91" y="0" />'
require_text Modules/General/BuyEmAllClassic.xml '<Offset x="159" y="0" />'
require_text Modules/General/BuyEmAllClassic.xml '<FontString name="GW2PlusBuyEmAllCurrencyAmt1" inherits="GameFontNormal" justifyH="RIGHT" text="">'
require_text Modules/General/BuyEmAllClassic.xml '<FontString name="GW2PlusBuyEmAllCurrencyAmt2" inherits="GameFontNormal" justifyH="RIGHT" text="">'
require_text Modules/General/BuyEmAllClassic.xml '<FontString name="GW2PlusBuyEmAllCurrencyAmt3" inherits="GameFontNormal" justifyH="RIGHT" text="">'
