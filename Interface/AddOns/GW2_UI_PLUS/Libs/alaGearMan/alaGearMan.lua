...
local texture_add = "Interface\\AddOns\\GW2_UI_PLUS\\Assets\\icons\\heart_of_thorns_map.tga";
...
function func.gm_CreateButton(parent, index, buttonHeight)
	...
	delete:SetNormalTexture("Interface\\AddOns\\GW2_UI_PLUS\\Assets\\icons\\cancel.tga");
	delete:SetPushedTexture("Interface\\AddOns\\GW2_UI_PLUS\\Assets\\icons\\cancel.tga");
	...
	modify:SetNormalTexture("Interface\\AddOns\\GW2_UI_PLUS\\Assets\\icons\\mainmenumicrobutton-down.tga");
	modify:SetPushedTexture("Interface\\AddOns\\GW2_UI_PLUS\\Assets\\icons\\mainmenumicrobutton-down.tga");
	...
	up:SetNormalTexture("Interface\\AddOns\\GW2_UI_PLUS\\Assets\\icons\\arrowup_up.tga");
	up:SetPushedTexture("Interface\\AddOns\\GW2_UI_PLUS\\Assets\\icons\\arrowup_down.tga");
	up:SetDisabledTexture("Interface\\AddOns\\GW2_UI_PLUS\\Assets\\icons\\arrowup_up.tga");
	...
	down:SetNormalTexture("Interface\\AddOns\\GW2_UI_PLUS\\Assets\\icons\\arrowdown_up.tga");
	down:SetPushedTexture("Interface\\AddOns\\GW2_UI_PLUS\\Assets\\icons\\arrowdown_down.tga");
	down:SetDisabledTexture("Interface\\AddOns\\GW2_UI_PLUS\\Assets\\icons\\arrowdown_up.tga");
...
function func.initUI()
	...
	ui.open:SetNormalTexture("Interface\\AddOns\\GW2_UI_PLUS\\Assets\\icons\\garrison-up.tga");
	ui.open:SetPushedTexture("Interface\\AddOns\\GW2_UI_PLUS\\Assets\\icons\\garrison-down.tga");
	ui.open:SetHighlightTexture("Interface\\AddOns\\GW2_UI_PLUS\\Assets\\icons\\garrison-down.tga");
	...
	do	--win
		...
		ui.setting:SetNormalTexture("Interface\\AddOns\\GW2_UI_PLUS\\Assets\\icons\\settings-window-icon.tga");
		ui.setting:SetPushedTexture("Interface\\AddOns\\GW2_UI_PLUS\\Assets\\icons\\settings-window-icon.tga");
...
function func.ADDON_LOADED(addon)
	if addon == ADDON then
        if GW2_UI_PLUS_SV and GW2_UI_PLUS_SV.alaGearMan_Enable == false then
            _EventHandler:UnregisterAllEvents()
            if ui.open then ui.open:Hide() end
            if ui.gearWin then ui.gearWin:Hide() end
            if ui.quick then ui.quick:Hide() end
            if ui.secure then ui.secure:Hide() end
            return
        end
