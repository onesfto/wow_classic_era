...
do --简体说明书
    ns.instructionsText = {
        ...
        " ",
        "|cff00FF00" ..[[7月31日更新v2.2.3]] ,
        [[-角色总览：增加显示"饰品"]] ,
        [[-批量邮寄工资：右上角增加一个禁用此功能的选项]] ,
        [[-交易记录/邮件记录：保存时长增加永久选项]] ,
        " " ,
    }
    ns.updateText_now = {
        -- "|cff00FF00" ..[[]] ,
        ...
        -- [[]] ,
        -- " " ,
        "|cff00FF00" .. [[7月30日更新v2.2.2]],
        c1 .. [[-新增功能：历史账单汇总（根据你的历史账单，可查看自己角色的消费记录，入口在表格右上角）]],
        c1 .. [[-新增功能：团长历史喊话（用于核对账单与团长的喊话是否一致，入口在表格底部）]],
        c1 .. [[-新增功能：预设心理价格（入口在表格底部）]],
        c1 .. [[-新增功能：预设拍卖价格/一键开拍（入口在表格底部）]],
        c1 .. [[-新增功能：批量邮寄工资（入口在邮箱界面）]],
        c1 .. [[-新增功能：支出模版（入口在支出格子旁边的绿字"支出"）]],
        c1 .. [[-角色总览：支持查看角色装备（输入/BGR，然后点击角色名字）]],
        " ",
    }
    ns.updateText_before = {
        "|cff00FF00" .. [[7月26日更新v2.2.1]],
        [[-移除团员成就功能]],
        " ",
        "|cff00FF00" .. [[7月26日更新v2.2.0]],
        [[-<时光服>移除查询全部角色功能]],
        c1 .. [[-新增功能：交易记录（入口在表格底部）]],
        c1 .. [[-新增功能：邮寄记录（入口在表格底部）]],
        c1 .. [[-新增功能：商品总览（入口在商人界面右上角）]],
        c1 .. [[-角色总览：新增"自定义排序"（可自由拖拽排序，入口在设置-角色总览）]],
        c1 .. [[-角色总览：新增"角色备注"（默认不勾选，入口在设置-角色总览）]],
        " ",
