...
BG.Init2(function()
    ...
    elseif BG.IsMOP then
        CreateButton(L["奥格"], function()
            mainFrame.moduleSelect:SetSelected(addonName .. "_DungeonsAndRaids")
            mainFrame.subCatSelect:SetSelected("SiegeofOrgrimmar")
            ClickSelectButton(6, 1, "notRefresh")
        end)
        CreateButton(L["T16"], function()
            mainFrame.moduleSelect:SetSelected(addonName .. "_Collections")
            mainFrame.subCatSelect:SetSelected("TierSets")
            mainFrame.boss:SetSelected(17)
            ClickSelectButton(4, 1, "notRefresh")
        end)
        CreateButton(L["天神"], function()
            mainFrame.moduleSelect:SetSelected(addonName .. "_Collections")
            mainFrame.subCatSelect:SetSelected("AugustStoneClusterVendor" .. GetVerText())
