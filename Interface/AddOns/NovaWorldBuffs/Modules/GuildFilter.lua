...
local filterTypeLocales = {
	["filterYells"] = {
		...
		["Nefarian will drop in 12 seconds."] = true, --EN "nefarianFirstYellMsg".
		...
		["Nefarian Buff in 12 Sekunden."] = true,
		...
		["Nefarian va être posé dans 12 secondes."] = true,
		...
		["Нефариан будет бафнут через 12 секунд."] = true,
