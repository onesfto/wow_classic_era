...
- 修改 `Interface/AddOns/GW2_UI_PLUS/tests/SettingsStructure_test.lua`
  - 验证顶级设置页的控件结构、范围和默认值。
- 修改 `docs/handoffs/2026-07-28-gw2-ui-plus-hotkey-position.md`
  - 更新最终位置模型、默认值和诊断方法。
...
**Files:**
- Modify: `docs/handoffs/2026-07-28-gw2-ui-plus-hotkey-position.md`
...
git diff --check -- Interface/AddOns/GW2_UI_PLUS/ActionBar \
  ...
  docs/handoffs/2026-07-28-gw2-ui-plus-hotkey-position.md
```
...
```bash
git add docs/handoffs/2026-07-28-gw2-ui-plus-hotkey-position.md
